...
def signup():
    if request.method =="POST":
        ...
        if existing_user is None:
            users.insert({"username":request.form['username'], "password":request.form['password'], "first-name":request.form['first-name'], "last-name":request.form['last-name'], 'email':request.form['email']})
